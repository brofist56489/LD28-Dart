...
// Native classes
// Method closures
$$.BoundClosure$1 = [Z, {"": "BoundClosure;_self,_target,_receiver,__js_helper$_name",
  call$1: function(p0) {
...
$$.Closure$0 = [Z, {"": "Closure;call$0,$name"}];
...
["DROID_AGE", "droidAge.dart", , Z, {
Display_init: function() {
  $.Display_canvas = document.querySelector("#targetCanvas");
  J.set$width$x($.Display_canvas, $.Display_WIDTH);
  J.set$height$x($.Display_canvas, $.Display_HEIGHT);
  $.Display_context = J.getContext$1$x($.Display_canvas, "2d");
  J.set$imageSmoothingEnabled$x($.Display_context, false);
},

Display_drawTiledImage: function(x, y, img, tileId, tileWidth) {
  var t1, t2, t3, tx, ty;
  t1 = J.getInterceptor$x(img);
  t2 = t1.get$width(img);
  if (t2 === 0 || t1.get$height(img) === 0)
    return;
  t1 = $.Display_xOff;
  t3 = $.Display_yOff;
  if (typeof t2 !== "number")
    throw t2.$tdiv();
  t2 = C.JSInt_methods.$tdiv(t2, tileWidth);
  tx = C.JSInt_methods.$mod(tileId, t2);
  ty = C.JSInt_methods.$tdiv(tileId, t2);
  J.drawImageScaledFromSource$9$x($.Display_context, img, tx * tileWidth, ty * tileWidth, tileWidth, tileWidth, x - t1, y - t3, tileWidth, tileWidth);
},

Display_drawRect: function(x, y, width, height, color, filled) {
  var t1;
  x -= $.Display_xOff;
  y -= $.Display_yOff;
  t1 = $.Display_context;
  if (filled) {
    ...
    J.fillRect$4$x($.Display_context, x, y, width, height);
  } else {
    J.set$strokeStyle$x(t1, color);
    J.strokeRect$4$x($.Display_context, x, y, width, height);
  }
},

Display_drawRotatedImage: function(x, y, img, radians) {
  var t1, t2, t3, t4, t5, t6;
  J.save$0$x($.Display_context);
  t1 = $.Display_context;
  t2 = $.Display_xOff;
  ...
  if (typeof t4 !== "number")
    throw t4.$div();
  t5 = $.Display_yOff;
  t6 = t3.get$height(img);
  if (typeof t6 !== "number")
    throw t6.$div();
  J.translate$2$x(t1, x - t2 + t4 / 2, y - t5 + t6 / 2);
  J.rotate$1$x($.Display_context, radians);
  t6 = $.Display_context;
  t5 = t3.get$width(img);
  if (typeof t5 !== "number")
    throw t5.$negate();
  ...
  if (typeof t3 !== "number")
    throw t3.$negate();
  J.drawImage$3$x(t6, img, -t5 / 2, -t3 / 2);
  J.restore$0$x($.Display_context);
},

Display_drawRotatedTileImage: function(x, y, img, tileId, tileWidth, radians, scale) {
  var t1, t2, tx, ty;
  if (img == null)
    return;
  t1 = J.getInterceptor$x(img);
  ...
  if (typeof t2 !== "number")
    throw t2.$tdiv();
  t1 = C.JSInt_methods.$tdiv(t2, tileWidth);
  tx = C.JSInt_methods.$mod(tileId, t1);
  ty = C.JSInt_methods.$tdiv(tileId, t1);
  J.save$0$x($.Display_context);
  t1 = tileWidth * scale;
  t2 = t1 / 2;
  J.translate$2$x($.Display_context, x - $.Display_xOff + t2, y - $.Display_yOff + t2);
  J.rotate$1$x($.Display_context, radians + 1.5707963267948966);
  t2 = -tileWidth * scale / 2;
  J.drawImageScaledFromSource$9$x($.Display_context, img, tx * tileWidth, ty * tileWidth, tileWidth, tileWidth, t2, t2, t1, t1);
  J.restore$0$x($.Display_context);
},

Display_drawText: function(x, y, msg, font, color) {
  var t1, t2;
  t1 = $.Display_xOff;
  t2 = $.Display_yOff;
  J.set$font$x($.Display_context, font);
  J.set$fillStyle$x($.Display_context, color);
  J.fillText$3$x($.Display_context, msg, x - t1, y - t2);
},

Display_loadImage: function(path) {
  var img = W.ImageElement_ImageElement(null, null, null);
  J.set$src$x(img, path);
  return img;
},

Display_centerOn: function(x, y) {
  $.Display_xOff = x - C.JSInt_methods.$tdiv($.Display_WIDTH, 2);
  $.Display_yOff = y - C.JSInt_methods.$tdiv($.Display_HEIGHT, 2);
},

Images_init: function() {
  $.Images_DROID = Z.Display_loadImage("../res/droids.png");
  $.Images_ROCKET = Z.Display_loadImage("../res/missle.png");
  $.Images_TEST_WORLD = Z.Display_loadImage("../res/testWorld.png");
  $.Images_TILE_MAP = Z.Display_loadImage("../res/tileMap2.png");
},

WorldLoader_loadWorld: function(path, world) {
  var img, t1, t2;
  img = Z.Display_loadImage(path);
  t1 = J.get$onLoad$x(img);
  t2 = new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new Z.WorldLoader_loadWorld_closure(world, img)), t1._useCapture);
...
Animator: {"": "Object;maxFrame,frame,time,maxTime,tileWidth",
  tick$0: function() {
...
Entity: {"": "Object;x>,y>",
  getRect$0: function() {
    return new Z.Rectangle(J.toInt$0$n(this.x), J.toInt$0$n(this.y), this.w, this.h);
  },
  loadTexture$0: function() {
    this.texture = $.Images_DROID;
  },
  tick$0: function() {
  ...
  checkCollision$2: function(ax, ay) {
    var t1, t2, rect, tx, ty, sy, sx, t3, sx0, t;
    t1 = this.x;
    if (typeof t1 !== "number")
      throw t1.$add();
    t1 = C.JSNumber_methods.toInt$0(t1 + ax + this.rxo);
    t2 = this.y;
    if (typeof t2 !== "number")
      throw t2.$add();
    rect = new Z.Rectangle(t1, C.JSNumber_methods.toInt$0(t2 + ay + this.ryo), this.w, this.h);
    t2 = this.x;
    if (typeof t2 !== "number")
      throw t2.$add();
    tx = C.JSNumber_methods.$tdiv(t2 + ax, 32);
    t2 = this.y;
    if (typeof t2 !== "number")
      throw t2.$add();
    ty = C.JSNumber_methods.$tdiv(t2 + ay, 32);
    for (sy = ty - 2, t1 = ty + 2, sx = tx - 2, t2 = tx + 2; sy <= t1; ++sy)
      for (t3 = sy * 32, sx0 = sx; sx0 <= t2; ++sx0) {
        t = this.world.getTile$2(sx0, sy);
        t.toString;
        if (rect.intersects$1(new Z.Rectangle(sx0 * 32, t3, 32, 32)) && t._solid)
          return true;
      }
    return false;
  },
  Entity$3: function(x, y, world) {
    var t1;
    this.x = x;
    this.y = y;
    this.world = world;
...
Droid: {"": "Entity;",
  ...
  tick$0: function() {
    Z.Entity.prototype.tick$0.call(this);
    this.move$0();
    this.fireCooldown = this.fireCooldown - 1;
    this.fireCooldown = P.max(this.fireCooldown, 0);
  },
  move$0: function() {
    var t1, ax, ay;
    t1 = this.legsRot;
    ax = Math.cos(t1) * this.speed;
    t1 = this.legsRot;
    ay = Math.sin(t1) * this.speed;
    if (!this.checkCollision$2(ax, 0)) {
      t1 = this.x;
      if (typeof t1 !== "number")
        throw t1.$add();
      this.x = t1 + ax;
    }
    if (!this.checkCollision$2(0, ay)) {
      t1 = this.y;
      if (typeof t1 !== "number")
        throw t1.$add();
      this.y = t1 + ay;
  ...
  fire$0: function() {
    if (this.fireCooldown === 0) {
      var r = Z.Rocket$(this.x, this.y, 3 + this.speed, this.bodyRot, this.world);
      this.world.entities.push(r);
      this.fireCooldown = this.maxFireCooldown;
    }
  },
  render$0: function() {
    Z.Display_drawRotatedTileImage(J.toInt$0$n(this.x), J.toInt$0$n(this.y), this.texture, this.legsIndex, 32, this.legsRot, 1);
    Z.Display_drawRotatedTileImage(J.toInt$0$n(this.x), J.toInt$0$n(this.y), this.texture, this.bodyIndex + 8, 32, this.bodyRot, 1);
  },
  Droid$3: function(x, y, world) {
    this.legsRot = 0.7853981633974483;
    this.w = 30;
    this.h = 30;
    this.rxo = 1;
    this.ryo = 1;
...
Player: {"": "Droid;lights,bodyRot,legsRot,bodyIndex,legsIndex,health,maxHealth,ammo,fireCooldown,maxFireCooldown,x,y,speed,rotation,rxo,ryo,w,h,animator,texture,world,alive,direction",
  tick$0: function() {
    var t1, t2;
    if ($.Game_keys._DROID_AGE$_keys.containsKey$1(65))
      this.legsRot = this.legsRot - 0.05;
    else if ($.Game_keys._DROID_AGE$_keys.containsKey$1(68))
      this.legsRot = this.legsRot + 0.05;
    t1 = $.Game_keys._DROID_AGE$_keys.containsKey$1(87);
    t2 = this.speed;
    if (t1)
      this.speed = t2 + 0.05;
    else
      this.speed = t2 - 0.1;
    if ($.Game_keys._DROID_AGE$_keys.containsKey$1(83))
      this.speed = this.speed - 0.15;
    this.speed = P.max(P.min(this.speed, 4), 0);
    if ($.Game_keys._DROID_AGE$_keys.containsKey$1(74))
      this.bodyRot = this.bodyRot - 0.1;
    else if ($.Game_keys._DROID_AGE$_keys.containsKey$1(76))
      this.bodyRot = this.bodyRot + 0.1;
    Z.Droid.prototype.tick$0.call(this);
    H.IterableMixinWorkaround_forEach(this.world.entities, new Z.Player_tick_closure(this));
    if ($.Game_keys._DROID_AGE$_keys.containsKey$1(73))
      this.fire$0();
    if ($.Game_keys._onceKeys.containsKey$1(32))
      this.placeTorch$0();
    this.health = this.health - 1;
  },
  placeTorch$0: function() {
    var t1, t2, sx, sy;
    t1 = this.x;
    t2 = this.w;
    if (typeof t2 !== "number")
    ...
    if (typeof t1 !== "number")
      throw t1.$add();
    sx = C.JSNumber_methods.$tdiv(t1 + t2 / 2, 32);
    t2 = this.y;
    t1 = this.h;
    if (typeof t1 !== "number")
      throw t1.$div();
    if (typeof t2 !== "number")
      throw t2.$add();
    sy = C.JSNumber_methods.$tdiv(t2 + t1 / 2, 32);
    if (this.world.getTile$2(sx, sy)._id === $.Tile_TORCH._id) {
      this.world.setTile$3(sx, sy, $.Tile_GRASS);
      this.lights = this.lights + 1;
    } else if (this.world.getTile$2(sx, sy)._id === $.Tile_GRASS._id) {
      if (this.lights <= 0)
        return;
      this.world.setTile$3(sx, sy, $.Tile_TORCH);
      this.lights = this.lights - 1;
    }
    this.world.updateLights$0();
  }
},

Player_tick_closure: {"": "Closure;this_0",
  call$1: function(e) {
    var t1 = J.getInterceptor(e);
    if (typeof e === "object" && e !== null && !!t1.$isPickup) {
      t1 = this.this_0;
      if (e.getRect$0().intersects$1(t1.getRect$0()))
        e.onPickup$1(t1);
    }
  },
  $is_args1: true
...
Enemy: {"": "Droid;targetRotation,target,bodyRot,legsRot,bodyIndex,legsIndex,health,maxHealth,ammo,fireCooldown,maxFireCooldown,x,y,speed,rotation,rxo,ryo,w,h,animator,texture,world,alive,direction",
  tick$0: function() {
    var t1, t2, t3, t4, mp, tp;
    if (this.target == null)
    ...
    if (typeof t4 !== "number")
      throw H.iae(t4);
    this.targetRotation = Math.atan2(t2 - t3, t1 - t4);
    t1 = this.targetRotation;
    t2 = this.legsRot;
    if (t1 > t2)
      this.legsRot = t2 + 0.05;
    else if (t1 < t2)
      this.legsRot = t2 - 0.05;
    t1 = this.targetRotation;
    t2 = this.bodyRot;
    if (t1 > t2)
      ...
      this.bodyRot = t2 - 0.1;
    mp = new P.Point(this.x, this.y);
    H.setRuntimeTypeInfo(mp, [null]);
    t1 = this.target;
    tp = new P.Point(t1.x, t1.y);
    H.setRuntimeTypeInfo(tp, [null]);
    t1 = mp.distanceTo$1(tp);
    t2 = this.speed;
    if (t1 < 96)
      this.speed = t2 - 0.2;
    else
      this.speed = t2 + 0.1;
    this.speed = P.max(P.min(this.speed, 3), 0);
    Z.Droid.prototype.tick$0.call(this);
    if (mp.distanceTo$1(tp) < 160)
      this.fire$0();
  }
},

Game: {"": "Object;running,timer,world,tickCount",
  render$0: function() {
    var t1, t2;
    t1 = $.Display_canvas;
    t2 = J.getInterceptor$x(t1);
    Z.Display_drawRect(0, 0, t2.get$width(t1), t2.get$height(t1), "black", true);
    Z.Display_centerOn(J.toInt$0$n(this.world.player.x), J.toInt$0$n(this.world.player.y));
    this.world.render$0();
    Z.Display_centerOn(320, 240);
    Z.Display_drawRect(0, $.Display_HEIGHT - 32, $.Display_WIDTH, 32, "#333", true);
    Z.Display_drawText(10, $.Display_HEIGHT - 6, "" + this.world.player.lights, "30px sans-serif", "#fff");
    t1 = this.world.player;
    Z.Display_drawRect(0, 0, C.JSInt_methods.toInt$0(t1.health / t1.maxHealth * $.Display_WIDTH), 20, "red", true);
  },
  Game$0: function() {
    var t1, t2;
    $.Game_random = C.C__Random;
    $.Game_keys = Z.Keyboard$();
    Z.Images_init();
    Z.Tile_init();
    Z.Display_init();
    t1 = new Z.GameTimer(P.DateTime$_now().millisecondsSinceEpoch, P.DateTime$_now().millisecondsSinceEpoch, null, 0.06, 0, 0, 0, null);
    t1.game = this;
    this.timer = t1;
    this.world = Z.World$();
    Z.WorldLoader_loadWorld("../res/testWorld.png", this.world);
    this.running = true;
    t1 = this.timer;
    t1.toString;
    t2 = window;
  ...
  static: {
"": "Game_random,Game_keys",
Game$: function() {
  var t1 = new Z.Game(null, null, null, 0);
  t1.Game$0();
  return t1;
}}
...
GameTimer: {"": "Object;ltr,lt,now,msPt,delta,ticks,frames,game",
  update$1: function(time) {
    var t1, t2, t3;
    this.now = P.DateTime$_now().millisecondsSinceEpoch;
    t1 = this.delta;
    t2 = this.now;
    t3 = this.lt;
    if (typeof t2 !== "number")
    ...
    if (typeof t3 !== "number")
      throw H.iae(t3);
    this.delta = t1 + (t2 - t3) * this.msPt;
    this.lt = this.now;
    for (; t1 = this.delta, t2 = this.game, t1 >= 1;) {
      t2.tickCount = t2.tickCount + 1;
      t2.world.tick$0();
      if (C.JSInt_methods.$mod(t2.tickCount, 600) === 0)
        t2.world.spawnEnemy$0();
      t1 = $.Game_keys._onceKeys;
    ...
    if (typeof t1 !== "number")
      throw t1.$sub();
    if (t1 - t2 >= 1000) {
      P.print("" + this.ticks + " tps, " + this.frames + " fps");
      this.ticks = 0;
      this.frames = 0;
      this.ltr = this.ltr + 1000;
    }
  ...
  get$update: function() {
    return new Z.BoundClosure$1(this, Z.GameTimer.prototype.update$1, null, "update$1");
  }
},

Pickup: {"": "Entity;",
  loadTexture$0: function() {
    this.texture = $.Images_TILE_MAP;
  },
  onPickup$1: function(e) {
  },
  tick$0: function() {
    if (!this.visible)
      this.visibleTimer = this.visibleTimer - 1;
    if (this.visibleTimer <= 0)
      this.visible = true;
  },
  render$0: function() {
    if (this.visible)
      Z.Display_drawTiledImage(J.toInt$0$n(this.x), J.toInt$0$n(this.y), this.texture, this.index + 24, 32);
  },
  $isPickup: true
},

TorchPickup: {"": "Pickup;visible,visibleTimer,index,x,y,speed,rotation,rxo,ryo,w,h,animator,texture,world,alive,direction",
  onPickup$1: function(e) {
    if (!this.visible)
      return;
    e.lights = e.lights + 5;
    this.visible = false;
    this.visibleTimer = 600;
  }
},

Projectile: {"": "Entity;",
  loadTexture$0: function() {
    this.texture = $.Images_ROCKET;
  },
  tick$0: function() {
    this.move$0();
  },
  ...
  render$0: function() {
    Z.Display_drawRotatedImage(J.toInt$0$n(this.x), J.toInt$0$n(this.y), this.texture, this.rotation);
  }
},

Rocket: {"": "Projectile;x,y,speed,rotation,rxo,ryo,w,h,animator,texture,world,alive,direction",
  onRemove$0: function() {
  },
  Rocket$5: function(x, y, speed, rotation, world) {
    this.w = 10;
    this.h = 6;
    this.rxo = 3;
    this.ryo = 5;
  ...
  static: {
Rocket$: function(x, y, speed, rotation, world) {
  var t1 = new Z.Rocket(null, null, 0, 0, 0, 0, null, null, null, null, null, true, null);
  t1.Entity$3(x, y, world);
  t1.speed = speed;
  t1.rotation = rotation;
  t1.Rocket$5(x, y, speed, rotation, world);
  return t1;
}}

},

Tile: {"": "Object;_id,_textId,_solid,_emitter",
  onSet$3: function(x, y, world) {
  },
  render$3: function(x, y, world) {
    Z.Display_drawTiledImage(x * 32, y * 32, $.Tile_tileMap, this._textId, 32);
  },
  Tile$4: function(id, textId, solid, emit) {
    var t1;
    this._id = id;
    t1 = $.Tile_tiles;
    t1.length;
    if (id < 0 || id >= 32)
      throw H.ioore(t1, id);
    if (t1[id] != null)
      throw H.wrapException(P.Exception_Exception("Duplicate Tiles: " + id));
    this._textId = textId;
    this._solid = solid;
    this._emitter = emit;
    t1[id] = this;
  ...
  static: {
"": "Tile_tileMap,Tile_SIZE,Tile_tiles,Tile_VOID,Tile_WALL,Tile_GRASS,Tile_TORCH",
Tile_init: function() {
  $.Tile_tileMap = $.Images_TILE_MAP;
  var t1 = P.List_List(32, Z.Tile);
  H.setRuntimeTypeInfo(t1, [Z.Tile]);
  $.Tile_tiles = t1;
  $.Tile_VOID = Z.Tile$(0, 0, false, false);
  t1 = new Z.ConnectingTile(null, null, null, null);
  t1.Tile$4(1, 8, true, false);
  $.Tile_WALL = t1;
  $.Tile_GRASS = Z.Tile$(2, 1, false, false);
  t1 = new Z.TorchTile(null, null, null, null);
  t1.Tile$4(3, 2, false, true);
  $.Tile_TORCH = t1;
},

Tile$: function(id, textId, solid, emit) {
  var t1 = new Z.Tile(null, null, null, null);
  t1.Tile$4(id, textId, solid, emit);
  return t1;
}}

},

ConnectingTile: {"": "Tile;_id,_textId,_solid,_emitter",
  checkConnection$3: function(x, y, world) {
    var u, d, l, r, i, t1;
    u = world.getTile$2(x, y - 1)._id === this._id;
    d = world.getTile$2(x, y + 1)._id === this._id;
    l = world.getTile$2(x - 1, y)._id === this._id;
    r = world.getTile$2(x + 1, y)._id === this._id;
    if (u && d && l && r)
      i = 10;
    else {
      t1 = !u;
    ...
    world.setData$3(x, y, i);
  },
  render$3: function(x, y, world) {
    var data, t1, t2;
    data = world.getData$2(x, y);
    t1 = $.Tile_tileMap;
    t2 = this._textId;
    if (typeof data !== "number")
      throw H.iae(data);
    Z.Display_drawTiledImage(x * 32, y * 32, t1, t2 + data, 32);
  },
  $isConnectingTile: true
},

TorchTile: {"": "Tile;_id,_textId,_solid,_emitter",
  onSet$3: function(x, y, world) {
    world.setData$3(x, y, 5);
  }
},

Rectangle: {"": "Object;x>,y>,w,h",
  intersects$1: function(r2) {
    var t1, t2, t3;
    t1 = this.x;
    t2 = r2.x;
    t3 = r2.w;
...
Keyboard: {"": "Object;_DROID_AGE$_keys,_onceKeys",
  Keyboard$0: function() {
    var t1, t2;
    t1 = new W._EventStream(window, C.EventStreamProvider_keydown._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new Z.Keyboard_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = new W._EventStream(window, C.EventStreamProvider_keyup._eventType, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t1 = new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new Z.Keyboard_closure0(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
  },
  static: {
Keyboard$: function() {
  var t1 = new Z.Keyboard(P.HashMap_HashMap(null, null, null, J.JSInt, J.JSInt), P.HashMap_HashMap(null, null, null, J.JSInt, J.JSInt));
  t1.Keyboard$0();
  return t1;
}}
...
Keyboard_closure: {"": "Closure;this_0",
  call$1: function(e) {
    var t1, t2;
    t1 = this.this_0;
    t2 = t1._DROID_AGE$_keys;
    if (!t2.containsKey$1(J.get$keyCode$x(e)))
      t2.$indexSet(t2, e.keyCode, e.timeStamp);
    t1 = t1._onceKeys;
    if (!t1.containsKey$1(e.keyCode))
...
Keyboard_closure0: {"": "Closure;this_1",
  call$1: function(e) {
    ...
    t1 = this.this_1;
    t2 = t1._DROID_AGE$_keys;
    t2.remove$1(t2, J.get$keyCode$x(e));
    t1 = t1._onceKeys;
...
World: {"": "Object;tiles,data,lighting,entities,player",
  spawnEnemy$0: function() {
    var found, tx, ty, light, t, e;
    for (found = false; !found;) {
      $.Game_random.toString;
      tx = Math.random() * 100 >>> 0;
      $.Game_random.toString;
      ty = Math.random() * 100 >>> 0;
      light = this.getLighting$2(tx, ty);
      t = this.getTile$2(tx, ty);
      if (typeof light !== "number")
        throw light.$le();
      if (light <= 20)
        if (!t._solid) {
          e = new Z.Enemy(0, null, 0, 0, 0, 0, 100, 100, 100, 10, 10, null, null, 0, 0, 0, 0, null, null, null, null, null, true, null);
          e.Entity$3(tx * 32 + 0, ty * 32 + 0, this);
          e.legsRot = 0.7853981633974483;
          e.w = 30;
          e.h = 30;
          e.rxo = 1;
          e.ryo = 1;
          e.speed = 0;
          e.maxFireCooldown = 70;
          this.entities.push(e);
          found = true;
        }
    }
  },
  initTiles$0: function() {
    var y, t1, x;
    for (y = 0; y < 100; ++y)
      for (t1 = y === 14, x = 0; x < 100; ++x) {
        this.setTile$3(x, y, $.Tile_VOID);
        if (t1)
          this.setTile$3(x, y, $.Tile_WALL);
        if (x === 19)
          this.setTile$3(x, y, $.Tile_WALL);
        this.setData$3(x, y, 0);
        this.setLighting$3(x, y, 32);
      }
    this.updateConnections$0();
    this.updateLights$0();
  },
  updateConnections$0: function() {
    var y, x, t1, t2;
    for (y = 0; y < 100; ++y)
      for (x = 0; x < 100; ++x) {
        t1 = this.getTile$2(x, y);
        t2 = J.getInterceptor(t1);
        if (typeof t1 === "object" && t1 !== null && !!t2.$isConnectingTile)
          H.interceptedTypeCast(this.getTile$2(x, y), "$isConnectingTile").checkConnection$3(x, y, this);
      }
  },
  getTile$2: function(x, y) {
    var t1, t2, t3;
  ...
  updateLights$0: function() {
    var y, x, lightSources, t1, p;
    for (y = 0; y < 100; ++y)
      for (x = 0; x < 100; ++x)
        this.setLighting$3(x, y, 0);
    lightSources = P.List_List(null, P.Point);
    H.setRuntimeTypeInfo(lightSources, [P.Point]);
    for (y = 0; y < 100; ++y)
      for (x = 0; x < 100; ++x)
        if (this.getTile$2(x, y)._emitter) {
          t1 = new P.Point(x, y);
          t1.$builtinTypeInfo = [null];
          lightSources.push(t1);
        }
    for (y = 0; y < 100; ++y)
      for (x = 0; x < 100; ++x) {
        t1 = {};
        ...
        H.IterableMixinWorkaround_forEach(lightSources, new Z.World_updateLights_closure(t1, this, p));
        t1.lightLevel_0 = P.max(P.min(t1.lightLevel_0, 32), 0);
        this.setLighting$3(x, y, t1.lightLevel_0);
      }
  },
  tick$0: function() {
    var i, t1, t2, e;
    for (i = 0; t1 = this.entities, t2 = t1.length, i < t2; ++i) {
      if (i < 0)
        throw H.ioore(t1, i);
      e = t1[i];
      e.tick$0();
      if (!e.alive) {
        e.onRemove$0();
        C.JSArray_methods.remove$1(this.entities, e);
        --i;
        continue;
      }
    }
  ...
  render$0: function() {
    var t1, t2, t3, mix, max, miy, may, y, x, i;
    t1 = this.player;
    t2 = t1.x;
    t3 = $.Display_WIDTH / 2;
    if (typeof t2 !== "number")
      throw t2.$sub();
    mix = C.JSNumber_methods.$tdiv(t2 - t3, 32) - 2;
    max = C.JSNumber_methods.$tdiv(t2 + t3, 32) + 2;
    t1 = t1.y;
    t3 = $.Display_HEIGHT / 2;
    if (typeof t1 !== "number")
      throw t1.$sub();
    miy = C.JSNumber_methods.$tdiv(t1 - t3, 32) - 2;
    may = C.JSNumber_methods.$tdiv(t1 + t3, 32) + 2;
    for (y = miy; y < may; ++y)
      for (x = mix; x < max; ++x)
        this.getTile$2(x, y).render$3(x, y, this);
    for (i = 0; t1 = this.entities, i < t1.length; ++i)
      t1[i].render$0();
    this.player.render$0();
    for (y = miy; y < may; ++y)
      for (t1 = y * 32, x = mix; x < max; ++x) {
        t2 = this.getLighting$2(x, y);
        if (typeof t2 !== "number")
          throw H.iae(t2);
        Z.Display_drawRect(x * 32, t1, 32, 32, "rgba(0, 0, 0, " + H.S((32 - t2) / 32) + ")", true);
      }
  },
  World$0: function() {
    var t1 = P.List_List(null, Z.Entity);
    H.setRuntimeTypeInfo(t1, [Z.Entity]);
    this.entities = t1;
    this.initTiles$0();
    t1 = new Z.Player(5, 0, 0, 0, 0, 100, 100, 100, 10, 10, null, null, 0, 0, 0, 0, null, null, null, null, null, true, null);
    t1.Entity$3(150, 150, this);
    t1.Droid$3(150, 150, this);
    this.player = t1;
    t1 = new Z.Enemy(0, null, 0, 0, 0, 0, 100, 100, 100, 10, 10, null, null, 0, 0, 0, 0, null, null, null, null, null, true, null);
    t1.Entity$3(100, 100, this);
    t1.Droid$3(100, 100, this);
    t1.maxFireCooldown = 70;
    this.entities.push(t1);
    t1 = new Z.TorchPickup(true, 120, 0, null, null, 0, 0, 0, 0, null, null, null, null, null, true, null);
    t1.Entity$3(0, 0, this);
    t1.w = 16;
    t1.h = 16;
    this.entities.push(t1);
  },
...
World$: function() {
  var t1, t2, t3;
  t1 = P.List_List(10000, J.JSInt);
  H.setRuntimeTypeInfo(t1, [J.JSInt]);
  t2 = P.List_List(10000, J.JSInt);
  H.setRuntimeTypeInfo(t2, [J.JSInt]);
  t3 = P.List_List(10000, J.JSInt);
  H.setRuntimeTypeInfo(t3, [J.JSInt]);
  t3 = new Z.World(t1, t2, t3, null, null);
  t3.World$0();
  return t3;
}}
...
World_updateLights_closure: {"": "Closure;box_0,this_1,p_2",
  call$1: function(lightP) {
    var t1, maxLight, change;
    t1 = J.getInterceptor$x(lightP);
    maxLight = this.this_1.getData$2(t1.get$x(lightP), t1.get$y(lightP));
    t1 = lightP.distanceTo$1(this.p_2);
    if (typeof maxLight !== "number")
      throw maxLight.$sub();
    change = C.JSNumber_methods.toInt$0((maxLight - t1) / maxLight * 32);
    if (change > 0) {
      t1 = this.box_0;
      t1.lightLevel_0 = t1.lightLevel_0 + change;
    }
  },
  $is_args1: true
},

WorldLoader_loadWorld_closure: {"": "Closure;world_0,img_1",
  call$1: function(e) {
    var t1, t2, t3, ctx, data, y, t4, x, index, tile;
    t1 = this.img_1;
    t2 = J.getInterceptor$x(t1);
    t3 = t2.get$width(t1);
    ctx = J.getContext$1$x(W.CanvasElement_CanvasElement(t2.get$height(t1), t3), "2d");
    J.drawImage$3$x(ctx, t1, 0, 0);
    data = J.get$data$x(P.convertNativeToDart_ImageData(ctx.getImageData(0, 0, t2.get$width(t1), t2.get$height(t1))));
    t3 = this.world_0;
    y = 0;
    while (true) {
      t4 = t2.get$height(t1);
      ...
      while (true) {
        ...
        if (!(x < t4))
          break;
        index = (x + y * t4) * 4;
        if (index < 0 || index >= C.JS_CONST_ZYJ(data))
          throw H.ioore(data, index);
        tile = data[index];
        if (tile >= 100)
          tile = 2;
        t4 = $.Tile_tiles;
        t4.length;
        if (tile < 0 || tile >= 32)
          throw H.ioore(t4, tile);
        t3.setTile$3(x, y, t4[tile]);
        ++x;
      }
      ++y;
    }
    t3.updateConnections$0();
    t3.updateLights$0();
  },
  $is_args1: true
}},
...
_MessageTraverser: {"": "Object;",
  ...
  get$_dispatch: function() {
    return new Z.BoundClosure$1(this, H._MessageTraverser.prototype._dispatch$1, null, "_dispatch$1");
  },
...
CanvasRenderingContext2D: {"": "CanvasRenderingContext;fillStyle},font},imageSmoothingEnabled},strokeStyle}",
...
init.globalFunctions.main$closure = Z.main$closure = new Z.Closure$0(Z.main, "main$closure");
...
init.globalFunctions.toStringWrapper$closure = H.toStringWrapper$closure = new Z.Closure$0(H.toStringWrapper, "toStringWrapper$closure");
init.globalFunctions.invokeClosure$closure = H.invokeClosure$closure = new H.Closure$7(H.invokeClosure, "invokeClosure$closure");
init.globalFunctions._asyncRunCallback$closure = P._asyncRunCallback$closure = new Z.Closure$0(P._asyncRunCallback, "_asyncRunCallback$closure");
...
init.globalFunctions._nullDoneHandler$closure = P._nullDoneHandler$closure = new Z.Closure$0(P._nullDoneHandler, "_nullDoneHandler$closure");
...
Z.Entity.$isEntity = true;
Z.Entity.$isObject = true;
Z.Tile.$isObject = true;
...
$.Images_DROID = null;
$.Images_ROCKET = null;
$.Images_TEST_WORLD = null;
$.Images_TILE_MAP = null;
$.Tile_tileMap = null;
$.Tile_tiles = null;
$.Tile_VOID = null;
$.Tile_WALL = null;
...
function dart_precompiled($collectedClasses) {
  ...
  function Animator(maxFrame, frame, time, maxTime, tileWidth) {
  ...
  Animator.builtin$cls = "Animator";
  if (!"name" in Animator)
    Animator.name = "Animator";
  $desc = $collectedClasses.Animator;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Animator.prototype = $desc;
  function Entity(x, y) {
    this.x = x;
    this.y = y;
  }
  ...
  Droid.builtin$cls = "Droid";
  if (!"name" in Droid)
    Droid.name = "Droid";
  $desc = $collectedClasses.Droid;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Droid.prototype = $desc;
  function Player(lights, bodyRot, legsRot, bodyIndex, legsIndex, health, maxHealth, ammo, fireCooldown, maxFireCooldown, x, y, speed, rotation, rxo, ryo, w, h, animator, texture, world, alive, direction) {
    this.lights = lights;
    this.bodyRot = bodyRot;
    this.legsRot = legsRot;
  ...
  function Player_tick_closure(this_0) {
    this.this_0 = this_0;
  }
  Player_tick_closure.builtin$cls = "Player_tick_closure";
  if (!"name" in Player_tick_closure)
    Player_tick_closure.name = "Player_tick_closure";
  $desc = $collectedClasses.Player_tick_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Player_tick_closure.prototype = $desc;
  function Enemy(targetRotation, target, bodyRot, legsRot, bodyIndex, legsIndex, health, maxHealth, ammo, fireCooldown, maxFireCooldown, x, y, speed, rotation, rxo, ryo, w, h, animator, texture, world, alive, direction) {
  ...
  function Game(running, timer, world, tickCount) {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  function GameTimer(ltr, lt, now, msPt, delta, ticks, frames, game) {
    this.ltr = ltr;
    this.lt = lt;
    this.now = now;
    this.msPt = msPt;
  ...
  GameTimer.builtin$cls = "GameTimer";
  if (!"name" in GameTimer)
    GameTimer.name = "GameTimer";
  $desc = $collectedClasses.GameTimer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GameTimer.prototype = $desc;
  ...
  Pickup.builtin$cls = "Pickup";
  if (!"name" in Pickup)
    Pickup.name = "Pickup";
  $desc = $collectedClasses.Pickup;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Pickup.prototype = $desc;
  function TorchPickup(visible, visibleTimer, index, x, y, speed, rotation, rxo, ryo, w, h, animator, texture, world, alive, direction) {
  ...
  TorchPickup.builtin$cls = "TorchPickup";
  if (!"name" in TorchPickup)
    TorchPickup.name = "TorchPickup";
  $desc = $collectedClasses.TorchPickup;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TorchPickup.prototype = $desc;
  function Projectile() {
  }
  ...
  function Rocket(x, y, speed, rotation, rxo, ryo, w, h, animator, texture, world, alive, direction) {
    this.x = x;
    this.y = y;
    this.speed = speed;
    this.rotation = rotation;
  ...
  Rocket.builtin$cls = "Rocket";
  if (!"name" in Rocket)
    Rocket.name = "Rocket";
  $desc = $collectedClasses.Rocket;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Rocket.prototype = $desc;
  function Tile(_id, _textId, _solid, _emitter) {
    this._id = _id;
    this._textId = _textId;
    this._solid = _solid;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Tile.prototype = $desc;
  function ConnectingTile(_id, _textId, _solid, _emitter) {
    this._id = _id;
    this._textId = _textId;
    this._solid = _solid;
    this._emitter = _emitter;
  }
  ConnectingTile.builtin$cls = "ConnectingTile";
  if (!"name" in ConnectingTile)
    ConnectingTile.name = "ConnectingTile";
  $desc = $collectedClasses.ConnectingTile;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConnectingTile.prototype = $desc;
  function TorchTile(_id, _textId, _solid, _emitter) {
    this._id = _id;
    this._textId = _textId;
    this._solid = _solid;
    this._emitter = _emitter;
  }
  TorchTile.builtin$cls = "TorchTile";
  if (!"name" in TorchTile)
    TorchTile.name = "TorchTile";
  $desc = $collectedClasses.TorchTile;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TorchTile.prototype = $desc;
  ...
  function Keyboard(_DROID_AGE$_keys, _onceKeys) {
    this._DROID_AGE$_keys = _DROID_AGE$_keys;
    this._onceKeys = _onceKeys;
  }
  ...
  function World(tiles, data, lighting, entities, player) {
    this.tiles = tiles;
    this.data = data;
  ...
  function World_updateLights_closure(box_0, this_1, p_2) {
    this.box_0 = box_0;
    this.this_1 = this_1;
    this.p_2 = p_2;
  }
  World_updateLights_closure.builtin$cls = "World_updateLights_closure";
  if (!"name" in World_updateLights_closure)
    World_updateLights_closure.name = "World_updateLights_closure";
  $desc = $collectedClasses.World_updateLights_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_updateLights_closure.prototype = $desc;
  function WorldLoader_loadWorld_closure(world_0, img_1) {
    this.world_0 = world_0;
    this.img_1 = img_1;
  }
  WorldLoader_loadWorld_closure.builtin$cls = "WorldLoader_loadWorld_closure";
  if (!"name" in WorldLoader_loadWorld_closure)
    WorldLoader_loadWorld_closure.name = "WorldLoader_loadWorld_closure";
  $desc = $collectedClasses.WorldLoader_loadWorld_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WorldLoader_loadWorld_closure.prototype = $desc;
  ...
  function ReceivePortImpl(__isolate_helper$_id, _controller) {
